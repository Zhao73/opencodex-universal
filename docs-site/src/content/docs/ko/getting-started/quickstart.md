...
([프로바이더](/opencodex-universal/ko/guides/providers/) 참고).
...
- [작동 방식](/opencodex-universal/ko/getting-started/how-it-works/) — 각 요청에 무슨 일이 일어나는지.
- [프로바이더](/opencodex-universal/ko/guides/providers/) — 인증하는 모든 방법.
- [구성](/opencodex-universal/ko/reference/configuration/) — 전체 `config.json` 레퍼런스.
