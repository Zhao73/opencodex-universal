...
[ウェブダッシュボード](/opencodex-universal/ja/guides/web-dashboard/)でも管理できます。
...
opencodex が管理対象[バックグラウンドサービス](/opencodex-universal/ja/reference/cli/#ocx-service)として実行されるときは
