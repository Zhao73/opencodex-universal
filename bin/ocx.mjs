 ...
 * `npm install -g opencodex-universal` work without a separately-installed Bun,
...
function fail(msg) {
  console.error(
    `opencodex: ${msg}\n` +
      ...
      "  npm install -g --allow-scripts=bun opencodex-universal\n" +
