...
([プロバイダー](/opencodex-universal/ja/guides/providers/)参照)。
...
- [仕組み](/opencodex-universal/ja/getting-started/how-it-works/) — 各リクエストで何が起きるか。
- [プロバイダー](/opencodex-universal/ja/guides/providers/) — 認証のすべての方法。
- [設定](/opencodex-universal/ja/reference/configuration/) — 完全な `config.json` リファレンス。
