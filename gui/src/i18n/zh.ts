...
export const zh: Record<TKey, string> = {
  ...
  "logs.detail.estimate.provider_cost_multiplier": "已应用该提供方仅用于估算的费用倍率。",
  "logs.col.error": "错误",
  ...
  "pws.costMultiplier": "估算倍率",
  "pws.costMultiplierEstimate": "仅用于估算",
  "pws.costMultiplierHint": "仅乘算 OpenCodex 的标价等值估算，不会改变上游实际计费。",
  ...
  "pws.fast": "加速",
  "pws.vision": "视觉",
  "pws.reasoningLevels": "推理：{levels}",
  "pws.defaultReasoning": "默认推理：{level}",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "gateway.connect.eyebrow": "一次粘贴接入",
  "gateway.connect.title": "粘贴 API Key",
  "gateway.connect.subtitle": "粘贴密钥，或直接粘贴服务商给你的「Base URL + Key」整段。OpenCodex 会自动识别网关、读取该密钥可用的模型，并把每个密钥导入为独立提供方。粘贴多个密钥即可同时接入多个网关。",
  "gateway.connect.placeholder": "sk-...\n或：Base URL: https://mallowapi.com/v1\n    API Key: sk-...",
  "gateway.connect.baseUrlPlaceholder": "Base URL（可选，例如 https://mallowapi.com）",
  "gateway.connect.setDefault": "把第一个连接设为默认提供方",
  "gateway.connect.action": "识别并接入",
  "gateway.connect.busy": "正在探测网关…",
  "gateway.connect.failed": "该密钥接入失败。",
  "gateway.connect.refreshed": "已刷新",
  "gateway.connect.models": "{n} 个模型",
  "gateway.open": "批量导入网关",
  "gateway.imported": "已导入网关：{names}。",
  "gateway.eyebrow": "通用网关导入",
  "gateway.title": "一次连接多个网关",
  "gateway.subtitle": "一次性添加相互独立的 One API、New API、Sub2API 或 OpenAI 兼容端点。每个连接分别保存 URL、凭据、协议和模型，并在写入前统一校验。",
  "gateway.connection": "连接 {n}",
  "gateway.removeAria": "移除连接 {n}",
  "gateway.id": "提供方 ID",
  "gateway.idPlaceholder": "team-gpt",
  "gateway.label": "显示名称（可选）",
  "gateway.labelPlaceholder": "主力编程网关",
  "gateway.kind": "网关类型",
  "gateway.kind.openaiCompatible": "OpenAI 兼容",
  "gateway.kind.oneApi": "One API",
  "gateway.kind.newApi": "New API",
  "gateway.kind.sub2api": "Sub2API",
  "gateway.protocol": "API 协议",
  "gateway.protocol.chatCompletions": "Chat Completions",
  "gateway.protocol.responses": "Responses",
  "gateway.costMultiplier": "估算倍率",
  "gateway.costMultiplierHint": "仅用于显示估算，不会改变网关的实际计费。",
  "gateway.baseUrl": "Base URL",
  "gateway.baseUrlPlaceholder": "https://gateway.example.com/v1",
  "gateway.credential": "凭据",
  "gateway.credential.stored": "在本机保存 API 密钥",
  "gateway.credential.env": "使用环境变量",
  "gateway.credential.none": "无需密钥",
  "gateway.apiKey": "API 密钥",
  "gateway.apiKeyPlaceholder": "粘贴此连接的密钥",
  "gateway.env": "环境变量",
  "gateway.envPlaceholder": "TEAM_GPT_API_KEY",
  "gateway.keylessHint": "仅当该端点确实允许无密钥请求时使用。",
  "gateway.models": "模型（可选）",
  "gateway.modelsPlaceholder": "gpt-5.6-sol\ngpt-5.6-terra\ngrok-4.5",
  "gateway.modelsHint": "每行一个模型，也可用逗号分隔。留空则依赖实时模型发现。",
  "gateway.defaultModel": "默认模型（可选）",
  "gateway.defaultModelPlaceholder": "gpt-5.6-sol",
  "gateway.capabilities": "高级模型能力",
  "gateway.capabilitiesJson": "能力配置（JSON）",
  "gateway.capabilitiesPlaceholder": "{\n  \"gpt-5.6-sol\": {\n    \"reasoningEfforts\": [\"low\", \"medium\", \"high\", \"xhigh\"],\n    \"serviceTiers\": [\"priority\"]\n  }\n}",
  "gateway.capabilitiesHint": "可选的 Manifest v2 模型元数据，以模型 ID 为键。只有该连接确实支持 Fast 请求时才声明 priority。",
  "gateway.liveModels": "从端点实时发现模型",
  "gateway.liveModelsHint": "OpenCodex 构建模型目录时，从此连接刷新模型列表。",
  "gateway.privateNetwork": "允许私有网络端点",
  "gateway.privateNetworkHint": "仅 localhost、局域网或其他私有 IP 目标需要开启。",
  "gateway.add": "再添加一个连接",
  "gateway.importSettings": "导入设置",
  "gateway.defaultProvider": "导入后的默认提供方",
  "gateway.replace": "覆盖同名提供方",
  "gateway.replaceHint": "默认关闭。仅在明确需要覆盖已有提供方设置时开启。",
  "gateway.error.missingId": "每个连接都需要提供方 ID。",
  "gateway.error.invalidId": "提供方 ID 须以字母或数字开头，仅可包含字母、数字、点、下划线或连字符。",
  "gateway.error.duplicateId": "连接 ID 不得重复，且忽略大小写。",
  "gateway.error.missingBaseUrl": "每个连接都需要 Base URL。",
  "gateway.error.missingApiKey": "请输入 API 密钥，或选择其他凭据方式。",
  "gateway.error.missingEnv": "请输入保存此连接 API 密钥的环境变量名。",
  "gateway.error.invalidCostMultiplier": "估算倍率必须是大于 0 且不超过 1000 的数字。",
  "gateway.error.invalidModelProfiles": "能力配置必须是以模型 ID 为键的有效 JSON 对象。",
  "gateway.error.request": "网关校验失败。",
  "gateway.error.preflight": "网关连接测试失败。",
  "gateway.error.network": "无法连接本机 OpenCodex 管理 API。",
  "gateway.validationOk": "{n} 个连接已通过校验。将覆盖已有提供方：{replacements}。目前尚未保存任何更改。",
  "gateway.validationCapabilities": "已配置能力的模型：{profiled}；推理档位：{reasoning}；支持 Fast：{fast}。",
  "gateway.ready": "校验完成，可以导入。",
  "gateway.validateHint": "导入前须先校验全部连接。",
  "gateway.validate": "校验",
  "gateway.validating": "校验中…",
  "gateway.probe.title": "连接证据",
  "gateway.probe.subtitle": "模型目录、标准推理和 Fast 推理是三项独立检查。推理测试需要明确开启，并可能消耗上游额度。",
  "gateway.probe.run": "测试连接",
  "gateway.probe.running": "测试中…",
  "gateway.probe.catalog": "模型目录",
  "gateway.probe.inference": "最小推理",
  "gateway.probe.inferenceHint": "每个连接发送一次短标准请求，可能产生费用。",
  "gateway.probe.fast": "已声明的 Fast 档位",
  "gateway.probe.fastHint": "对明确声明 Fast 的连接发送一次短 priority 请求，可能产生费用。",
  "gateway.probe.status.passed": "通过",
  "gateway.probe.status.failed": "失败",
  "gateway.probe.status.skipped": "已跳过",
  "gateway.probe.message.catalogOk": "端点返回了 {n} 个模型。",
  "gateway.probe.message.configuredModelMissing": "端点返回了 {n} 个模型，但不包含 {model}。",
  "gateway.probe.message.staticCatalog": "已关闭实时发现；仍可使用静态模型配置。",
  "gateway.probe.message.missingCredential": "没有可用凭据。",
  "gateway.probe.message.invalidCatalog": "模型目录返回了不支持的数据结构。",
  "gateway.probe.message.invalidInference": "推理返回了不支持的数据结构。",
  "gateway.probe.message.tooLarge": "诊断响应超过安全大小限制。",
  "gateway.probe.message.invalidJson": "端点返回了无效 JSON。",
  "gateway.probe.message.timeout": "上游诊断超时。",
  "gateway.probe.message.network": "诊断无法连接该端点。",
  "gateway.probe.message.modelRequired": "请先配置具体模型，再测试推理。",
  "gateway.probe.message.notDeclared": "没有模型明确声明 priority 服务。",
  "gateway.probe.message.notRequested": "未要求执行此项检查。",
  "gateway.probe.message.inferenceOk": "真实最小推理成功。",
  "gateway.probe.message.fastConfirmed": "Fast 推理成功，且响应确认了 priority。",
  "gateway.probe.message.fastUnconfirmed": "Fast 推理成功，但响应未确认 priority。",
  "gateway.probe.message.http": "端点返回 HTTP {status}。",
  "gateway.probe.message.unknown": "诊断返回了未知结果。",
  "gateway.import": "导入连接",
  "gateway.importing": "导入中…",
};
