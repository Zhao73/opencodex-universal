...
[Как это работает](/opencodex-universal/ru/getting-started/how-it-works/).
...
- `codex/catalog.ts` сливает маршрутизируемые модели в каталог Codex как записи с пространствами
  ...
  [модели подагентов](/opencodex-universal/ru/guides/codex-integration/#the-subagent-picker) первыми,
