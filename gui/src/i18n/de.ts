...
export const de = {
  ...
  "logs.detail.estimate.provider_cost_multiplier": "Der reine Schätzfaktor des Anbieters wurde angewendet.",
  ...
  "pws.costMultiplier": "Schätzfaktor",
  "pws.costMultiplierEstimate": "nur Schätzung",
  "pws.costMultiplierHint": "Multipliziert nur den Listenpreis-Schätzwert von OpenCodex. Die Abrechnung des Upstreams bleibt unverändert.",
  ...
  "pws.fast": "Schnell",
  "pws.vision": "Bildeingabe",
  "pws.reasoningLevels": "Reasoning: {levels}",
  "pws.defaultReasoning": "Standard-Reasoning: {level}",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "gateway.connect.eyebrow": "Verbinden per Einfügen",
  "gateway.connect.title": "API-Schlüssel einfügen",
  "gateway.connect.subtitle": "Fügen Sie einen Schlüssel ein — oder gleich den ganzen Block aus Base URL und Schlüssel. OpenCodex erkennt das Gateway, liest die für diesen Schlüssel freigegebenen Modelle und importiert jeden Schlüssel als eigenen Provider. Mehrere Schlüssel gleichzeitig einfügen betreibt mehrere Gateways parallel.",
  "gateway.connect.placeholder": "sk-...\noder: Base URL: https://mallowapi.com/v1\n      API Key: sk-...",
  "gateway.connect.baseUrlPlaceholder": "Base URL (optional, z. B. https://mallowapi.com)",
  "gateway.connect.setDefault": "Erste Verbindung als Standard-Provider setzen",
  "gateway.connect.action": "Erkennen und verbinden",
  "gateway.connect.busy": "Gateway wird geprüft…",
  "gateway.connect.failed": "Dieser Schlüssel konnte nicht verbunden werden.",
  "gateway.connect.refreshed": "aktualisiert",
  "gateway.connect.models": "{n} Modelle",
  "gateway.open": "Gateways importieren",
  "gateway.imported": "Gateways importiert: {names}.",
  "gateway.eyebrow": "Universeller Gateway-Import",
  "gateway.title": "Mehrere Gateways verbinden",
  "gateway.subtitle": "Füge unabhängige One API-, New API-, Sub2API- oder OpenAI-kompatible Endpunkte in einem validierten Import hinzu. Jede Verbindung behält eigene URL, Zugangsdaten, Protokoll und Modelle.",
  "gateway.connection": "Verbindung {n}",
  "gateway.removeAria": "Verbindung {n} entfernen",
  "gateway.id": "Anbieter-ID",
  "gateway.idPlaceholder": "team-gpt",
  "gateway.label": "Anzeigename (optional)",
  "gateway.labelPlaceholder": "Primäres Coding-Gateway",
  "gateway.kind": "Gateway-Typ",
  "gateway.kind.openaiCompatible": "OpenAI-kompatibel",
  "gateway.kind.oneApi": "One API",
  "gateway.kind.newApi": "New API",
  "gateway.kind.sub2api": "Sub2API",
  "gateway.protocol": "API-Protokoll",
  "gateway.protocol.chatCompletions": "Chat Completions",
  "gateway.protocol.responses": "Responses",
  "gateway.costMultiplier": "Schätzfaktor",
  "gateway.costMultiplierHint": "Nur für die Anzeige; ändert die tatsächliche Abrechnung des Gateways nicht.",
  "gateway.baseUrl": "Basis-URL",
  "gateway.baseUrlPlaceholder": "https://gateway.example.com/v1",
  "gateway.credential": "Zugangsdaten",
  "gateway.credential.stored": "API-Schlüssel lokal speichern",
  "gateway.credential.env": "Umgebungsvariable verwenden",
  "gateway.credential.none": "Kein Schlüssel erforderlich",
  "gateway.apiKey": "API-Schlüssel",
  "gateway.apiKeyPlaceholder": "Schlüssel für diese Verbindung einfügen",
  "gateway.env": "Umgebungsvariable",
  "gateway.envPlaceholder": "TEAM_GPT_API_KEY",
  "gateway.keylessHint": "Nur verwenden, wenn der Endpunkt wirklich Anfragen ohne Schlüssel akzeptiert.",
  "gateway.models": "Modelle (optional)",
  "gateway.modelsPlaceholder": "gpt-5.6-sol\ngpt-5.6-terra\ngrok-4.5",
  "gateway.modelsHint": "Ein Modell pro Zeile oder kommagetrennt. Leer lassen für Live-Modellerkennung.",
  "gateway.defaultModel": "Standardmodell (optional)",
  "gateway.defaultModelPlaceholder": "gpt-5.6-sol",
  "gateway.capabilities": "Erweiterte Modellfunktionen",
  "gateway.capabilitiesJson": "Funktionsprofile (JSON)",
  "gateway.capabilitiesPlaceholder": "{\n  \"gpt-5.6-sol\": {\n    \"reasoningEfforts\": [\"low\", \"medium\", \"high\", \"xhigh\"],\n    \"serviceTiers\": [\"priority\"]\n  }\n}",
  "gateway.capabilitiesHint": "Optionale Manifest-v2-Metadaten nach Modell-ID. priority nur angeben, wenn diese Verbindung Fast-Anfragen tatsächlich unterstützt.",
  "gateway.liveModels": "Modelle vom Endpunkt erkennen",
  "gateway.liveModelsHint": "Modellliste beim Aufbau des OpenCodex-Katalogs von dieser Verbindung aktualisieren.",
  "gateway.privateNetwork": "Privaten Netzwerk-Endpunkt erlauben",
  "gateway.privateNetworkHint": "Nur für localhost, LAN oder andere private IP-Ziele erforderlich.",
  "gateway.add": "Weitere Verbindung hinzufügen",
  "gateway.importSettings": "Importeinstellungen",
  "gateway.defaultProvider": "Standardanbieter nach Import",
  "gateway.replace": "Gleiche Anbieter-IDs ersetzen",
  "gateway.replaceHint": "Standardmäßig aus. Nur aktivieren, wenn vorhandene Anbietereinstellungen überschrieben werden sollen.",
  "gateway.error.missingId": "Jede Verbindung benötigt eine Anbieter-ID.",
  "gateway.error.invalidId": "Anbieter-IDs müssen mit Buchstabe oder Zahl beginnen und dürfen nur Buchstaben, Zahlen, Punkte, Unterstriche oder Bindestriche enthalten.",
  "gateway.error.duplicateId": "Verbindungs-IDs müssen unabhängig von Groß-/Kleinschreibung eindeutig sein.",
  "gateway.error.missingBaseUrl": "Jede Verbindung benötigt eine Basis-URL.",
  "gateway.error.missingApiKey": "API-Schlüssel eingeben oder anderen Zugangsdatenmodus wählen.",
  "gateway.error.missingEnv": "Umgebungsvariable mit dem API-Schlüssel dieser Verbindung eingeben.",
  "gateway.error.invalidCostMultiplier": "Der Schätzfaktor muss größer als 0 und höchstens 1000 sein.",
  "gateway.error.invalidModelProfiles": "Funktionsprofile müssen ein gültiges JSON-Objekt mit Modell-IDs als Schlüssel sein.",
  "gateway.error.request": "Gateway-Validierung fehlgeschlagen.",
  "gateway.error.preflight": "Gateway-Verbindungstest fehlgeschlagen.",
  "gateway.error.network": "Lokale OpenCodex-Verwaltungs-API ist nicht erreichbar.",
  "gateway.validationOk": "Validierung für {n} Verbindung(en) bestanden. Vorhandene Anbieter zum Ersetzen: {replacements}. Noch wurde nichts gespeichert.",
  "gateway.validationCapabilities": "Modelle mit Profil: {profiled}. Reasoning-Steuerung: {reasoning}. Fast-fähig: {fast}.",
  "gateway.ready": "Validiert und importbereit.",
  "gateway.validateHint": "Vor dem Import alle Verbindungen validieren.",
  "gateway.validate": "Validieren",
  "gateway.validating": "Validierung…",
  "gateway.probe.title": "Verbindungsnachweise",
  "gateway.probe.subtitle": "Katalog, Standard-Inferenz und Fast-Inferenz sind getrennte Prüfungen. Inferenztests sind optional und können Guthaben verbrauchen.",
  "gateway.probe.run": "Verbindungen testen",
  "gateway.probe.running": "Test läuft…",
  "gateway.probe.catalog": "Katalog",
  "gateway.probe.inference": "Minimale Inferenz",
  "gateway.probe.inferenceHint": "Sendet pro Verbindung eine kurze Standardanfrage. Es können Kosten entstehen.",
  "gateway.probe.fast": "Deklarierte Fast-Stufe",
  "gateway.probe.fastHint": "Sendet für jede Verbindung mit deklarierter Fast-Unterstützung eine kurze priority-Anfrage. Es können Kosten entstehen.",
  "gateway.probe.status.passed": "Bestanden",
  "gateway.probe.status.failed": "Fehlgeschlagen",
  "gateway.probe.status.skipped": "Übersprungen",
  "gateway.probe.message.catalogOk": "Der Endpunkt lieferte {n} Modell(e).",
  "gateway.probe.message.configuredModelMissing": "Der Endpunkt lieferte {n} Modell(e), aber nicht {model}.",
  "gateway.probe.message.staticCatalog": "Live-Erkennung ist deaktiviert; statische Modelle bleiben verfügbar.",
  "gateway.probe.message.missingCredential": "Keine verwendbaren Zugangsdaten verfügbar.",
  "gateway.probe.message.invalidCatalog": "Der Modellkatalog hat ein nicht unterstütztes Antwortformat.",
  "gateway.probe.message.invalidInference": "Die Inferenz hat ein nicht unterstütztes Antwortformat.",
  "gateway.probe.message.tooLarge": "Die Diagnoseantwort überschritt das sichere Größenlimit.",
  "gateway.probe.message.invalidJson": "Der Endpunkt lieferte ungültiges JSON.",
  "gateway.probe.message.timeout": "Zeitüberschreitung bei der Upstream-Diagnose.",
  "gateway.probe.message.network": "Die Diagnose konnte den Endpunkt nicht erreichen.",
  "gateway.probe.message.modelRequired": "Vor dem Inferenztest muss ein konkretes Modell konfiguriert werden.",
  "gateway.probe.message.notDeclared": "Kein Modell deklariert ausdrücklich priority-Unterstützung.",
  "gateway.probe.message.notRequested": "Diese Prüfung wurde nicht angefordert.",
  "gateway.probe.message.inferenceOk": "Eine echte minimale Inferenz war erfolgreich.",
  "gateway.probe.message.fastConfirmed": "Fast-Inferenz war erfolgreich und priority wurde bestätigt.",
  "gateway.probe.message.fastUnconfirmed": "Fast-Inferenz war erfolgreich, aber priority wurde nicht bestätigt.",
  "gateway.probe.message.http": "Der Endpunkt lieferte HTTP {status}.",
  "gateway.probe.message.unknown": "Die Diagnose lieferte ein unbekanntes Ergebnis.",
  "gateway.import": "Verbindungen importieren",
  "gateway.importing": "Import läuft…",
} as const;
