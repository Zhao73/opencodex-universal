...
公开文档发布到 GitHub Pages：<https://zhao73.github.io/opencodex-universal/zh-cn/>。
...
[Adapters](/opencodex-universal/zh-cn/reference/adapters/)），在 `src/server/adapter-resolve.ts` 注册其名称，
