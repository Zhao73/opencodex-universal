...
[web dashboard](/opencodex-universal/guides/web-dashboard/).
...
When opencodex runs as a managed [background service](/opencodex-universal/reference/cli/#ocx-service), it sets
