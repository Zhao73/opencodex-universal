...
OpenAI beta/originator/session — see [Adapters](/opencodex-universal/reference/adapters/)). This path is also
what powers the [web-search and vision sidecars](/opencodex-universal/guides/sidecars/).
...
You can also start OAuth from the [web dashboard](/opencodex-universal/guides/web-dashboard/).
...
[CLI reference](/opencodex-universal/reference/cli/#ocx-account-subcommand) for commands, JSON output, and
...
See the [Configuration reference](/opencodex-universal/reference/configuration/#cursor-provider-adapter-cursor)
...
lineup by vision capability so the [vision sidecar](/opencodex-universal/guides/sidecars/) only kicks in for
...
[Configuration reference](/opencodex-universal/reference/configuration/) for every provider field
