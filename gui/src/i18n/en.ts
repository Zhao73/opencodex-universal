...
export const en = {
  ...
  "logs.detail.estimate.provider_cost_multiplier": "The provider's estimate-only cost multiplier was applied.",
  ...
  "pws.costMultiplier": "Estimate multiplier",
  "pws.costMultiplierEstimate": "estimate only",
  "pws.costMultiplierHint": "Multiplies OpenCodex's list-price equivalent only. It does not change upstream billing.",
  ...
  "pws.defaultReasoning": "Default reasoning: {level}",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "gateway.connect.eyebrow": "One-paste connect",
  "gateway.connect.title": "Paste an API key",
  "gateway.connect.subtitle": "Paste a key — or the whole Base URL + key block your provider gave you. OpenCodex identifies the gateway, reads the models that key can use, and imports each key as its own provider. Paste several keys to run several gateways side by side.",
  "gateway.connect.placeholder": "sk-...\nor: Base URL: https://mallowapi.com/v1\n    API Key: sk-...",
  "gateway.connect.baseUrlPlaceholder": "Base URL (optional, e.g. https://mallowapi.com)",
  "gateway.connect.setDefault": "Make the first connection the default provider",
  "gateway.connect.action": "Detect and connect",
  "gateway.connect.busy": "Probing gateway…",
  "gateway.connect.failed": "Could not connect this key.",
  "gateway.connect.refreshed": "refreshed",
  "gateway.connect.models": "{n} models",
  "gateway.open": "Import gateways",
  "gateway.imported": "Imported gateways: {names}.",
  "gateway.eyebrow": "Universal gateway import",
  "gateway.title": "Connect multiple gateways",
  "gateway.subtitle": "Add independent One API, New API, Sub2API, or OpenAI-compatible endpoints in one validated import. Each connection keeps its own URL, credential, protocol, and models.",
  "gateway.connection": "Connection {n}",
  "gateway.removeAria": "Remove connection {n}",
  "gateway.id": "Provider ID",
  "gateway.idPlaceholder": "team-gpt",
  "gateway.label": "Display label (optional)",
  "gateway.labelPlaceholder": "Primary coding gateway",
  "gateway.kind": "Gateway type",
  ...
  "gateway.protocol": "API protocol",
  "gateway.protocol.chatCompletions": "Chat Completions",
  "gateway.protocol.responses": "Responses",
  "gateway.costMultiplier": "Estimate multiplier",
  "gateway.costMultiplierHint": "Display estimate only; does not change the gateway's real billing.",
  "gateway.baseUrl": "Base URL",
  "gateway.baseUrlPlaceholder": "https://gateway.example.com/v1",
  "gateway.credential": "Credential",
  "gateway.credential.stored": "Save API key locally",
  "gateway.credential.env": "Use environment variable",
  "gateway.credential.none": "No key required",
  "gateway.apiKey": "API key",
  "gateway.apiKeyPlaceholder": "Paste the key for this connection",
  "gateway.env": "Environment variable",
  "gateway.envPlaceholder": "TEAM_GPT_API_KEY",
  "gateway.keylessHint": "Use only when this endpoint genuinely accepts requests without a key.",
  "gateway.models": "Models (optional)",
  "gateway.modelsPlaceholder": "gpt-5.6-sol\ngpt-5.6-terra\ngrok-4.5",
  "gateway.modelsHint": "One model per line or comma-separated. Leave empty to rely on live model discovery.",
  "gateway.defaultModel": "Default model (optional)",
  "gateway.defaultModelPlaceholder": "gpt-5.6-sol",
  "gateway.capabilities": "Advanced model capabilities",
  "gateway.capabilitiesJson": "Capability profiles (JSON)",
  "gateway.capabilitiesPlaceholder": "{\n  \"gpt-5.6-sol\": {\n    \"reasoningEfforts\": [\"low\", \"medium\", \"high\", \"xhigh\"],\n    \"serviceTiers\": [\"priority\"]\n  }\n}",
  "gateway.capabilitiesHint": "Optional manifest v2 metadata keyed by model ID. Declare priority only when this connection actually supports Fast requests.",
  "gateway.liveModels": "Discover models from the endpoint",
  "gateway.liveModelsHint": "Refresh the model list from this connection when OpenCodex builds its catalog.",
  "gateway.privateNetwork": "Allow a private-network endpoint",
  "gateway.privateNetworkHint": "Required only for localhost, LAN, or other private IP destinations.",
  "gateway.add": "Add another connection",
  "gateway.importSettings": "Import settings",
  "gateway.defaultProvider": "Default provider after import",
  "gateway.replace": "Replace matching provider IDs",
  "gateway.replaceHint": "Off by default. Turn on only when you intend to overwrite existing provider settings.",
  "gateway.error.missingId": "Every connection needs a provider ID.",
  "gateway.error.invalidId": "Provider IDs must start with a letter or number and use only letters, numbers, dots, underscores, or hyphens.",
  "gateway.error.duplicateId": "Connection IDs must be unique, including letter case.",
  "gateway.error.missingBaseUrl": "Every connection needs a Base URL.",
  "gateway.error.missingApiKey": "Enter an API key or select a different credential mode.",
  "gateway.error.missingEnv": "Enter the environment variable that contains this connection's API key.",
  "gateway.error.invalidCostMultiplier": "The estimate multiplier must be a positive number no greater than 1000.",
  "gateway.error.invalidModelProfiles": "Capability profiles must be a valid JSON object keyed by model ID.",
  "gateway.error.request": "Gateway validation failed.",
  "gateway.error.preflight": "Gateway connection test failed.",
  "gateway.error.network": "Could not reach the local OpenCodex management API.",
  "gateway.validationOk": "Validation passed for {n} connection(s). Existing providers to replace: {replacements}. No changes have been saved yet.",
  "gateway.validationCapabilities": "Profiled models: {profiled}. Reasoning controls: {reasoning}. Fast-capable: {fast}.",
  "gateway.ready": "Validated and ready to import.",
  "gateway.validateHint": "Validate all connections before import.",
  "gateway.validate": "Validate",
  "gateway.validating": "Validating…",
  "gateway.probe.title": "Connection evidence",
  "gateway.probe.subtitle": "Catalog, standard inference, and Fast inference are independent checks. Inference probes are opt-in and may consume provider credits.",
  "gateway.probe.run": "Test connections",
  "gateway.probe.running": "Testing…",
  "gateway.probe.catalog": "Catalog",
  "gateway.probe.inference": "Minimal inference",
  "gateway.probe.inferenceHint": "Send one short standard request per connection. This may incur a charge.",
  "gateway.probe.fast": "Declared Fast tier",
  "gateway.probe.fastHint": "Send one short priority request for each connection that explicitly declares Fast. This may incur a charge.",
  "gateway.probe.status.passed": "Passed",
  "gateway.probe.status.failed": "Failed",
  "gateway.probe.status.skipped": "Skipped",
  "gateway.probe.message.catalogOk": "The endpoint returned {n} model(s).",
  "gateway.probe.message.configuredModelMissing": "The endpoint returned {n} model(s), but not {model}.",
  "gateway.probe.message.staticCatalog": "Live discovery is disabled; static models remain available.",
  "gateway.probe.message.missingCredential": "No usable credential was available.",
  "gateway.probe.message.invalidCatalog": "The model catalog used an unsupported response shape.",
  "gateway.probe.message.invalidInference": "Inference returned an unsupported response shape.",
  "gateway.probe.message.tooLarge": "The diagnostic response exceeded the safe size limit.",
  "gateway.probe.message.invalidJson": "The endpoint returned invalid JSON.",
  "gateway.probe.message.timeout": "The upstream diagnostic timed out.",
  "gateway.probe.message.network": "The diagnostic could not connect to the endpoint.",
  "gateway.probe.message.modelRequired": "Configure a concrete model before testing inference.",
  "gateway.probe.message.notDeclared": "No model explicitly declares priority service.",
  "gateway.probe.message.notRequested": "This check was not requested.",
  "gateway.probe.message.inferenceOk": "A real minimal inference succeeded.",
  "gateway.probe.message.fastConfirmed": "Fast inference succeeded and priority was confirmed.",
  "gateway.probe.message.fastUnconfirmed": "Fast inference succeeded, but the response did not confirm priority.",
  "gateway.probe.message.http": "The endpoint returned HTTP {status}.",
  "gateway.probe.message.unknown": "The diagnostic returned an unknown result.",
  "gateway.import": "Import connections",
  "gateway.importing": "Importing…",
} as const;
