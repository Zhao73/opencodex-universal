...
export const ko: Record<TKey, string> = {
  ...
  "logs.detail.estimate.provider_cost_multiplier": "프로바이더의 추정 전용 비용 배수를 적용했습니다.",
  "logs.col.error": "오류",
  ...
  "pws.costMultiplier": "추정 배수",
  "pws.costMultiplierEstimate": "추정 전용",
  "pws.costMultiplierHint": "OpenCodex의 정가 상당 추정치에만 곱합니다. 업스트림 실제 청구는 바뀌지 않습니다.",
  ...
  "pws.fast": "빠른 모드",
  "pws.vision": "이미지 입력",
  "pws.reasoningLevels": "추론: {levels}",
  "pws.defaultReasoning": "기본 추론: {level}",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "gateway.connect.eyebrow": "붙여넣기 한 번으로 연결",
  "gateway.connect.title": "API 키 붙여넣기",
  "gateway.connect.subtitle": "키 하나, 또는 제공사가 준 「Base URL + 키」 블록을 그대로 붙여넣으세요. OpenCodex가 게이트웨이를 식별하고 그 키로 쓸 수 있는 모델을 불러와 키마다 별도 프로바이더로 가져옵니다. 여러 키를 붙여넣으면 여러 게이트웨이를 동시에 쓸 수 있습니다.",
  "gateway.connect.placeholder": "sk-...\n또는: Base URL: https://mallowapi.com/v1\n      API Key: sk-...",
  "gateway.connect.baseUrlPlaceholder": "Base URL (선택, 예: https://mallowapi.com)",
  "gateway.connect.setDefault": "첫 연결을 기본 프로바이더로 설정",
  "gateway.connect.action": "식별하고 연결",
  "gateway.connect.busy": "게이트웨이 확인 중…",
  "gateway.connect.failed": "이 키로는 연결하지 못했습니다.",
  "gateway.connect.refreshed": "갱신됨",
  "gateway.connect.models": "모델 {n}개",
  "gateway.open": "게이트웨이 가져오기",
  "gateway.imported": "게이트웨이를 가져왔습니다: {names}.",
  "gateway.eyebrow": "범용 게이트웨이 가져오기",
  "gateway.title": "여러 게이트웨이 연결",
  "gateway.subtitle": "서로 독립적인 One API, New API, Sub2API 또는 OpenAI 호환 엔드포인트를 한 번에 검증해 추가합니다. 각 연결은 URL, 자격 증명, 프로토콜, 모델을 별도로 유지합니다.",
  "gateway.connection": "연결 {n}",
  "gateway.removeAria": "연결 {n} 제거",
  "gateway.id": "프로바이더 ID",
  "gateway.idPlaceholder": "team-gpt",
  "gateway.label": "표시 이름(선택)",
  "gateway.labelPlaceholder": "기본 코딩 게이트웨이",
  "gateway.kind": "게이트웨이 유형",
  "gateway.kind.openaiCompatible": "OpenAI 호환",
  "gateway.kind.oneApi": "One API",
  "gateway.kind.newApi": "New API",
  "gateway.kind.sub2api": "Sub2API",
  "gateway.protocol": "API 프로토콜",
  "gateway.protocol.chatCompletions": "Chat Completions",
  "gateway.protocol.responses": "Responses",
  "gateway.costMultiplier": "추정 배수",
  "gateway.costMultiplierHint": "표시용 추정치에만 적용되며 게이트웨이의 실제 청구는 바뀌지 않습니다.",
  "gateway.baseUrl": "Base URL",
  "gateway.baseUrlPlaceholder": "https://gateway.example.com/v1",
  "gateway.credential": "자격 증명",
  "gateway.credential.stored": "API 키를 로컬에 저장",
  "gateway.credential.env": "환경 변수 사용",
  "gateway.credential.none": "키 필요 없음",
  "gateway.apiKey": "API 키",
  "gateway.apiKeyPlaceholder": "이 연결의 키를 붙여넣으세요",
  "gateway.env": "환경 변수",
  "gateway.envPlaceholder": "TEAM_GPT_API_KEY",
  "gateway.keylessHint": "이 엔드포인트가 실제로 키 없는 요청을 허용할 때만 사용하세요.",
  "gateway.models": "모델(선택)",
  "gateway.modelsPlaceholder": "gpt-5.6-sol\ngpt-5.6-terra\ngrok-4.5",
  "gateway.modelsHint": "한 줄에 하나씩 또는 쉼표로 구분합니다. 비워 두면 실시간 모델 검색을 사용합니다.",
  "gateway.defaultModel": "기본 모델(선택)",
  "gateway.defaultModelPlaceholder": "gpt-5.6-sol",
  "gateway.capabilities": "고급 모델 기능",
  "gateway.capabilitiesJson": "기능 프로필(JSON)",
  "gateway.capabilitiesPlaceholder": "{\n  \"gpt-5.6-sol\": {\n    \"reasoningEfforts\": [\"low\", \"medium\", \"high\", \"xhigh\"],\n    \"serviceTiers\": [\"priority\"]\n  }\n}",
  "gateway.capabilitiesHint": "모델 ID를 키로 사용하는 선택적 Manifest v2 메타데이터입니다. 이 연결이 Fast 요청을 실제로 지원할 때만 priority를 선언하세요.",
  "gateway.liveModels": "엔드포인트에서 모델 검색",
  "gateway.liveModelsHint": "OpenCodex 카탈로그를 만들 때 이 연결에서 모델 목록을 새로 고칩니다.",
  "gateway.privateNetwork": "사설 네트워크 엔드포인트 허용",
  "gateway.privateNetworkHint": "localhost, LAN 또는 기타 사설 IP 대상에만 필요합니다.",
  "gateway.add": "연결 하나 더 추가",
  "gateway.importSettings": "가져오기 설정",
  "gateway.defaultProvider": "가져온 뒤 기본 프로바이더",
  "gateway.replace": "일치하는 프로바이더 ID 교체",
  "gateway.replaceHint": "기본값은 꺼짐입니다. 기존 설정을 덮어쓸 때만 켜세요.",
  "gateway.error.missingId": "모든 연결에 프로바이더 ID가 필요합니다.",
  "gateway.error.invalidId": "프로바이더 ID는 문자나 숫자로 시작하고 문자, 숫자, 점, 밑줄, 하이픈만 사용할 수 있습니다.",
  "gateway.error.duplicateId": "연결 ID는 대소문자와 관계없이 고유해야 합니다.",
  "gateway.error.missingBaseUrl": "모든 연결에 Base URL이 필요합니다.",
  "gateway.error.missingApiKey": "API 키를 입력하거나 다른 자격 증명 방식을 선택하세요.",
  "gateway.error.missingEnv": "이 연결의 API 키가 들어 있는 환경 변수를 입력하세요.",
  "gateway.error.invalidCostMultiplier": "추정 배수는 0보다 크고 1000 이하여야 합니다.",
  "gateway.error.invalidModelProfiles": "기능 프로필은 모델 ID를 키로 사용하는 올바른 JSON 객체여야 합니다.",
  "gateway.error.request": "게이트웨이 검증에 실패했습니다.",
  "gateway.error.preflight": "게이트웨이 연결 테스트에 실패했습니다.",
  "gateway.error.network": "로컬 OpenCodex 관리 API에 연결할 수 없습니다.",
  "gateway.validationOk": "{n}개 연결의 검증을 통과했습니다. 교체할 기존 프로바이더: {replacements}. 아직 변경 사항은 저장되지 않았습니다.",
  "gateway.validationCapabilities": "프로필 모델: {profiled}. 추론 제어: {reasoning}. Fast 지원: {fast}.",
  "gateway.ready": "검증 완료, 가져올 준비가 되었습니다.",
  "gateway.validateHint": "가져오기 전에 모든 연결을 검증하세요.",
  "gateway.validate": "검증",
  "gateway.validating": "검증 중…",
  "gateway.probe.title": "연결 증거",
  "gateway.probe.subtitle": "모델 카탈로그, 표준 추론, Fast 추론은 서로 독립된 검사입니다. 추론 검사는 명시적으로 켜야 하며 업스트림 크레딧을 사용할 수 있습니다.",
  "gateway.probe.run": "연결 테스트",
  "gateway.probe.running": "테스트 중…",
  "gateway.probe.catalog": "카탈로그",
  "gateway.probe.inference": "최소 추론",
  "gateway.probe.inferenceHint": "연결마다 짧은 표준 요청을 한 번 보냅니다. 비용이 발생할 수 있습니다.",
  "gateway.probe.fast": "선언된 Fast 등급",
  "gateway.probe.fastHint": "Fast를 명시한 연결마다 짧은 priority 요청을 한 번 보냅니다. 비용이 발생할 수 있습니다.",
  "gateway.probe.status.passed": "통과",
  "gateway.probe.status.failed": "실패",
  "gateway.probe.status.skipped": "건너뜀",
  "gateway.probe.message.catalogOk": "엔드포인트가 모델 {n}개를 반환했습니다.",
  "gateway.probe.message.configuredModelMissing": "엔드포인트가 모델 {n}개를 반환했지만 {model}은(는) 포함되지 않았습니다.",
  "gateway.probe.message.staticCatalog": "실시간 검색이 꺼져 있으며 정적 모델 설정은 계속 사용할 수 있습니다.",
  "gateway.probe.message.missingCredential": "사용 가능한 자격 증명이 없습니다.",
  "gateway.probe.message.invalidCatalog": "모델 카탈로그 응답 형식이 지원되지 않습니다.",
  "gateway.probe.message.invalidInference": "추론 응답 형식이 지원되지 않습니다.",
  "gateway.probe.message.tooLarge": "진단 응답이 안전한 크기 제한을 초과했습니다.",
  "gateway.probe.message.invalidJson": "엔드포인트가 잘못된 JSON을 반환했습니다.",
  "gateway.probe.message.timeout": "업스트림 진단 시간이 초과되었습니다.",
  "gateway.probe.message.network": "진단에서 엔드포인트에 연결하지 못했습니다.",
  "gateway.probe.message.modelRequired": "추론 테스트 전에 구체적인 모델을 설정하세요.",
  "gateway.probe.message.notDeclared": "priority 서비스를 명시한 모델이 없습니다.",
  "gateway.probe.message.notRequested": "이 검사는 요청되지 않았습니다.",
  "gateway.probe.message.inferenceOk": "실제 최소 추론에 성공했습니다.",
  "gateway.probe.message.fastConfirmed": "Fast 추론에 성공했고 priority가 확인되었습니다.",
  "gateway.probe.message.fastUnconfirmed": "Fast 추론에는 성공했지만 응답에서 priority를 확인하지 못했습니다.",
  "gateway.probe.message.http": "엔드포인트가 HTTP {status}를 반환했습니다.",
  "gateway.probe.message.unknown": "진단 결과를 알 수 없습니다.",
  "gateway.import": "연결 가져오기",
  "gateway.importing": "가져오는 중…",
};
