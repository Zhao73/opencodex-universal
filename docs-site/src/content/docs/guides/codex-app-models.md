...
[Codex Integration](/opencodex-universal/guides/codex-integration/) for the full injection and restore flow.
...
cross-model router. See [Sub-agent Surface](/opencodex-universal/guides/sub-agent-surface/) for the canonical
behavior.
:::
