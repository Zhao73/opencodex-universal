...
[Интеграция с Codex](/opencodex-universal/ru/guides/codex-integration/).
...
описано в разделе [Поверхность подагентов](/opencodex-universal/ru/guides/sub-agent-surface/).
:::
