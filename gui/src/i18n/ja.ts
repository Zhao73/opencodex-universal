...
export const ja: Record<TKey, string> = {
  ...
  "logs.detail.estimate.provider_cost_multiplier": "プロバイダーの推定専用コスト倍率を適用しました。",
  "logs.col.error": "エラー",
  ...
  "nav.storage": "ストレージ",
  "storage.title": "ストレージ",
  "storage.subtitle": "CODEX_HOME ディスクの使用先の読み取り専用ビューです。このページでは何も削除しません。",
  ...
  "pws.workspaceToggle": "ワークスペースビュー",
  "pws.classicToggle": "クラシックビュー",
  "pws.tab.overview": "概要",
  "pws.tab.models": "モデル",
  "pws.tab.usage": "使用量",
  ...
  "pws.fast": "高速",
  "pws.vision": "画像入力",
  "pws.reasoningLevels": "推論：{levels}",
  "pws.defaultReasoning": "既定の推論：{level}",
  ...
  "codexAuth.switchDesc": "次回の Codex セッションから適用されます。現在のセッションは既存のアカウントのままです。",
  "codexAuth.cacheWarning": "アカウント切り替えでプロンプトキャッシュはリセットされます。新規セッションは空のキャッシュで開始します。",
  "codexAuth.setAsNext": "次回セッションに設定",
  "codexAuth.cancel": "キャンセル",
  "codexAuth.switchBack": "メインに戻しますか?",
  "codexAuth.switchBackDesc": "次回の Codex セッションはアプリログインアカウントを再び使用します。",
  "codexAuth.autoSwitch": "80% で自動切り替え",
  "codexAuth.autoSwitchDesc": "関連するクォータ枠がしきい値に達すると新規セッションが切り替わります; Go/Free は 30日のみ",
  "codexAuth.switched": "{email} は次回セッションから使用されます",
  "codexAuth.loadFailed": "アカウントを読み込めませんでした。",
  ...
  "codexAuth.copyLoginLink": "ログインリンクをコピー",
  "codexAuth.loginLinkCopied": "ログインリンクをコピーしました",
  "codexAuth.loginLinkCopyFailed": "ログインリンクをコピーできませんでした。",
  ...
  "api.endpointNote": "OpenAI Responses API 形式と互換があります。",
  ...
  "pws.costMultiplier": "推定倍率",
  "pws.costMultiplierEstimate": "推定専用",
  "pws.costMultiplierHint": "OpenCodex の定価相当推定だけに乗算します。上流の実請求は変更しません。",
  ...
  "gateway.connect.eyebrow": "貼り付けだけで接続",
  "gateway.connect.title": "API キーを貼り付け",
  "gateway.connect.subtitle": "キー、または提供元から渡された「Base URL + キー」のブロックをそのまま貼り付けてください。OpenCodex がゲートウェイを判別し、そのキーで使えるモデルを読み込み、キーごとに独立したプロバイダーとして取り込みます。複数のキーを貼れば複数のゲートウェイを同時に利用できます。",
  "gateway.connect.placeholder": "sk-...\nまたは: Base URL: https://mallowapi.com/v1\n      API Key: sk-...",
  "gateway.connect.baseUrlPlaceholder": "Base URL（任意・例 https://mallowapi.com）",
  "gateway.connect.setDefault": "最初の接続を既定プロバイダーにする",
  "gateway.connect.action": "判別して接続",
  "gateway.connect.busy": "ゲートウェイを確認中…",
  "gateway.connect.failed": "このキーでは接続できませんでした。",
  "gateway.connect.refreshed": "更新済み",
  "gateway.connect.models": "モデル {n} 件",
  "gateway.open": "ゲートウェイを一括追加",
  "gateway.imported": "ゲートウェイを追加しました: {names}。",
  "gateway.eyebrow": "汎用ゲートウェイインポート",
  "gateway.title": "複数のゲートウェイを接続",
  "gateway.subtitle": "独立した One API、New API、Sub2API、または OpenAI 互換エンドポイントを、検証付きで一括追加します。URL、認証情報、プロトコル、モデルは接続ごとに管理されます。",
  "gateway.connection": "接続 {n}",
  "gateway.removeAria": "接続 {n} を削除",
  "gateway.id": "プロバイダー ID",
  "gateway.idPlaceholder": "team-gpt",
  "gateway.label": "表示名（任意）",
  "gateway.labelPlaceholder": "メインのコーディングゲートウェイ",
  "gateway.kind": "ゲートウェイ種別",
  "gateway.kind.openaiCompatible": "OpenAI 互換",
  "gateway.kind.oneApi": "One API",
  "gateway.kind.newApi": "New API",
  "gateway.kind.sub2api": "Sub2API",
  "gateway.protocol": "API プロトコル",
  "gateway.protocol.chatCompletions": "Chat Completions",
  "gateway.protocol.responses": "Responses",
  "gateway.costMultiplier": "推定倍率",
  "gateway.costMultiplierHint": "表示上の推定専用です。ゲートウェイの実請求は変更しません。",
  "gateway.baseUrl": "Base URL",
  "gateway.baseUrlPlaceholder": "https://gateway.example.com/v1",
  "gateway.credential": "認証情報",
  "gateway.credential.stored": "API キーをローカル保存",
  "gateway.credential.env": "環境変数を使用",
  "gateway.credential.none": "キー不要",
  "gateway.apiKey": "API キー",
  "gateway.apiKeyPlaceholder": "この接続のキーを貼り付け",
  "gateway.env": "環境変数",
  "gateway.envPlaceholder": "TEAM_GPT_API_KEY",
  "gateway.keylessHint": "このエンドポイントが実際にキーなしのリクエストを受け付ける場合のみ使用してください。",
  "gateway.models": "モデル（任意）",
  "gateway.modelsPlaceholder": "gpt-5.6-sol\ngpt-5.6-terra\ngrok-4.5",
  "gateway.modelsHint": "1 行に 1 モデル、またはカンマ区切り。空欄の場合はライブモデル検出を使用します。",
  "gateway.defaultModel": "デフォルトモデル（任意）",
  "gateway.defaultModelPlaceholder": "gpt-5.6-sol",
  "gateway.capabilities": "高度なモデル機能",
  "gateway.capabilitiesJson": "機能プロファイル（JSON）",
  "gateway.capabilitiesPlaceholder": "{\n  \"gpt-5.6-sol\": {\n    \"reasoningEfforts\": [\"low\", \"medium\", \"high\", \"xhigh\"],\n    \"serviceTiers\": [\"priority\"]\n  }\n}",
  "gateway.capabilitiesHint": "モデル ID をキーにした任意の Manifest v2 メタデータです。この接続が Fast リクエストに対応する場合だけ priority を宣言してください。",
  "gateway.liveModels": "エンドポイントからモデルを検出",
  "gateway.liveModelsHint": "OpenCodex のカタログ作成時に、この接続からモデル一覧を更新します。",
  "gateway.privateNetwork": "プライベートネットワークを許可",
  "gateway.privateNetworkHint": "localhost、LAN、その他のプライベート IP 宛ての場合のみ必要です。",
  "gateway.add": "接続を追加",
  "gateway.importSettings": "インポート設定",
  "gateway.defaultProvider": "インポート後のデフォルトプロバイダー",
  "gateway.replace": "同じプロバイダー ID を置換",
  "gateway.replaceHint": "既定ではオフです。既存設定を意図的に上書きする場合のみオンにしてください。",
  "gateway.error.missingId": "すべての接続にプロバイダー ID が必要です。",
  "gateway.error.invalidId": "プロバイダー ID は英数字で始め、英数字、ドット、アンダースコア、ハイフンのみ使用できます。",
  "gateway.error.duplicateId": "接続 ID は大文字小文字を問わず一意である必要があります。",
  "gateway.error.missingBaseUrl": "すべての接続に Base URL が必要です。",
  "gateway.error.missingApiKey": "API キーを入力するか、別の認証方式を選択してください。",
  "gateway.error.missingEnv": "この接続の API キーを含む環境変数を入力してください。",
  "gateway.error.invalidCostMultiplier": "推定倍率は 0 より大きく 1000 以下の数値にしてください。",
  "gateway.error.invalidModelProfiles": "機能プロファイルはモデル ID をキーにした有効な JSON オブジェクトである必要があります。",
  "gateway.error.request": "ゲートウェイの検証に失敗しました。",
  "gateway.error.preflight": "ゲートウェイ接続テストに失敗しました。",
  "gateway.error.network": "ローカル OpenCodex 管理 API に接続できません。",
  "gateway.validationOk": "{n} 件の接続が検証に合格しました。置換する既存プロバイダー: {replacements}。まだ変更は保存されていません。",
  "gateway.validationCapabilities": "プロファイル済みモデル: {profiled}。推論コントロール: {reasoning}。Fast 対応: {fast}。",
  "gateway.ready": "検証済み。インポートできます。",
  "gateway.validateHint": "インポート前にすべての接続を検証してください。",
  "gateway.validate": "検証",
  "gateway.validating": "検証中…",
  "gateway.probe.title": "接続エビデンス",
  "gateway.probe.subtitle": "モデルカタログ、標準推論、Fast 推論は別々の検査です。推論テストは明示的に有効化し、上流クレジットを消費する場合があります。",
  "gateway.probe.run": "接続をテスト",
  "gateway.probe.running": "テスト中…",
  "gateway.probe.catalog": "カタログ",
  "gateway.probe.inference": "最小推論",
  "gateway.probe.inferenceHint": "接続ごとに短い標準リクエストを 1 回送信します。料金が発生する場合があります。",
  "gateway.probe.fast": "宣言済み Fast ティア",
  "gateway.probe.fastHint": "Fast を明示した接続ごとに短い priority リクエストを 1 回送信します。料金が発生する場合があります。",
  "gateway.probe.status.passed": "成功",
  "gateway.probe.status.failed": "失敗",
  "gateway.probe.status.skipped": "スキップ",
  "gateway.probe.message.catalogOk": "エンドポイントから {n} 件のモデルが返されました。",
  "gateway.probe.message.configuredModelMissing": "エンドポイントから {n} 件のモデルが返されましたが、{model} は含まれていません。",
  "gateway.probe.message.staticCatalog": "ライブ検出は無効です。静的モデル設定は利用できます。",
  "gateway.probe.message.missingCredential": "利用可能な認証情報がありません。",
  "gateway.probe.message.invalidCatalog": "モデルカタログの応答形式が未対応です。",
  "gateway.probe.message.invalidInference": "推論の応答形式が未対応です。",
  "gateway.probe.message.tooLarge": "診断応答が安全なサイズ上限を超えました。",
  "gateway.probe.message.invalidJson": "エンドポイントから無効な JSON が返されました。",
  "gateway.probe.message.timeout": "上流診断がタイムアウトしました。",
  "gateway.probe.message.network": "診断でエンドポイントに接続できませんでした。",
  "gateway.probe.message.modelRequired": "推論テスト前に具体的なモデルを設定してください。",
  "gateway.probe.message.notDeclared": "priority サービスを明示したモデルがありません。",
  "gateway.probe.message.notRequested": "この検査は要求されていません。",
  "gateway.probe.message.inferenceOk": "実際の最小推論に成功しました。",
  "gateway.probe.message.fastConfirmed": "Fast 推論に成功し、priority が確認されました。",
  "gateway.probe.message.fastUnconfirmed": "Fast 推論には成功しましたが、応答で priority を確認できませんでした。",
  "gateway.probe.message.http": "エンドポイントが HTTP {status} を返しました。",
  "gateway.probe.message.unknown": "診断結果が不明です。",
  "gateway.import": "接続をインポート",
  "gateway.importing": "インポート中…",
};
