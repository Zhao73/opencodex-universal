...
(参见 [Provider](/opencodex-universal/zh-cn/guides/providers/))。
...
- [工作原理](/opencodex-universal/zh-cn/getting-started/how-it-works/) —— 每个请求都发生了什么。
- [Provider](/opencodex-universal/zh-cn/guides/providers/) —— 各种认证方式。
- [配置](/opencodex-universal/zh-cn/reference/configuration/) —— 完整的 `config.json` 参考。
